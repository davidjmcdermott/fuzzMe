...
### USAGE #################################################
#
# First make sure that this module is imported:
#   import pattern
#
# To generate a pattern make the following call where
# PatternLength is the length you desire:
#   pattern.pattern_gen(PatternLength)
#
# To find an offset in the pattern make the following call:
#   pattern.pattern_search("0xDEADBEEF")
#
###########################################################
